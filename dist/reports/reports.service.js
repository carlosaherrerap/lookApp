...
let ReportsService = class ReportsService {
    ...
    clientRepository;
    eventsGateway;
    constructor(reportRepository, creditRepository, clientRepository, eventsGateway) {
    ...
    async createSyncReport(payload) {
        ...
        if (payload.travel_time_seconds != null)
            reportData.travel_time_seconds = payload.travel_time_seconds;
        if (payload.visit_time_seconds != null)
            reportData.visit_time_seconds = payload.visit_time_seconds;
        if (payload.photos && payload.photos.length > 0)
            reportData.photos = payload.photos;
